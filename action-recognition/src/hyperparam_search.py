...
from src.config import (  # noqa: E402
    BATCH_SIZE, BEST_HPARAMS_FILE, DATA_DIR, FRAME_SIZE, NUM_FRAMES,
    NUM_WORKERS, OUTPUT_DIR, SEED, WEIGHT_DECAY, get_classes,
)
...
def main():
    ...
    train_ds = VideoClipDataset(os.path.join(DATA_DIR, "train"), classes, NUM_FRAMES, FRAME_SIZE, train=True)
